    ...
    <React.Fragment>
      ...
      >
        ...
        >
          ...
          {/* <span className="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger"><span className="notification-badge">{resultNewJobs.length}</span><span className="visually-hidden">unread messages</span></span> */}
        </Dropdown.Toggle>
        <Dropdown.Menu
          ...
          <div className="dropdown-head rounded-top">
            <div className="p-3 border-bottom border-bottom-dashed">
              <Row className="align-items-center">
                <Col>
                  {/* <h6 className="mb-0 fs-16 fw-semibold"> Notifications <span className="badge badge-soft-danger fs-13 notification-badge"> {resultNewJobs.length}</span></h6> */}
                  <p className="fs-14 text-muted mt-1 mb-0">
                    You have{" "}
                    <span className="fw-semibold notification-unread">3</span>{" "}
                    unread messages
                  </p>
                </Col>
